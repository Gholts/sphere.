...
enum BackendConfigControl: Equatable, Sendable {
    ...
    func parsedValue(from text: String, fallback: JSONValue) -> JSONValue {
        switch self {
        case .toggle:
            return .bool(["true", "1", "yes", "on"].contains(text.trimmingCharacters(in: .whitespacesAndNewlines).lowercased()))
        case .number:
...
enum BackendConfigCatalog {
    ...
    private static let mihomoFields: [BackendConfigField] = [
        ...
        BackendConfigField(section: "Runtime", title: "Unified Delay", path: "unified-delay", control: .toggle),
        BackendConfigField(section: "Runtime", title: "TCP Concurrent", path: "tcp-concurrent", control: .toggle),
        BackendConfigField(section: "Runtime", title: "Find Process", path: "find-process-mode", control: .picker(["off", "strict", "always"])),
        BackendConfigField(section: "Runtime", title: "Sniffing", path: "sniffing", control: .toggle),
        BackendConfigField(section: "Runtime", title: "Client Fingerprint", path: "global-client-fingerprint", control: .text),
        BackendConfigField(section: "Runtime", title: "User Agent", path: "global-ua", control: .text),
        BackendConfigField(section: "Runtime", title: "Disable Keep Alive", path: "disable-keep-alive", control: .toggle),
        ...
        BackendConfigField(section: "API", title: "Controller Unix Socket", path: "external-controller-unix", control: .text),
        BackendConfigField(section: "API", title: "Controller Named Pipe", path: "external-controller-pipe", control: .text),
        BackendConfigField(section: "API", title: "Controller TLS", path: "external-controller-tls", control: .text),
        ...
        BackendConfigField(section: "DNS", title: "Cache Algorithm", path: "dns.cache-algorithm", control: .picker(["lru", "arc"])),
        BackendConfigField(section: "DNS", title: "Prefer HTTP/3", path: "dns.prefer-h3", control: .toggle),
        BackendConfigField(section: "DNS", title: "Use Hosts", path: "dns.use-hosts", control: .toggle),
        BackendConfigField(section: "DNS", title: "Use System Hosts", path: "dns.use-system-hosts", control: .toggle),
        BackendConfigField(section: "DNS", title: "Respect Rules", path: "dns.respect-rules", control: .toggle),
        BackendConfigField(section: "DNS", title: "Default Nameserver", path: "dns.default-nameserver", control: .stringList),
        BackendConfigField(section: "DNS", title: "Enhanced Mode", path: "dns.enhanced-mode", control: .picker(["redir-host", "fake-ip"])),
        BackendConfigField(section: "DNS", title: "Fake IP Range", path: "dns.fake-ip-range", control: .text),
        BackendConfigField(section: "DNS", title: "Fake IP Range IPv6", path: "dns.fake-ip-range6", control: .text),
        BackendConfigField(section: "DNS", title: "Fake IP Filter Mode", path: "dns.fake-ip-filter-mode", control: .picker(["blacklist", "whitelist", "rule"])),
        BackendConfigField(section: "DNS", title: "Fake IP Filter", path: "dns.fake-ip-filter", control: .stringList),
        BackendConfigField(section: "DNS", title: "Fake IP TTL", path: "dns.fake-ip-ttl", control: .number),
        BackendConfigField(section: "DNS", title: "Nameserver", path: "dns.nameserver", control: .stringList),
        BackendConfigField(section: "DNS", title: "Nameserver Policy", path: "dns.nameserver-policy", control: .json),
        BackendConfigField(section: "DNS", title: "Proxy Nameserver", path: "dns.proxy-server-nameserver", control: .stringList),
        BackendConfigField(section: "DNS", title: "Proxy Nameserver Policy", path: "dns.proxy-server-nameserver-policy", control: .json),
        BackendConfigField(section: "DNS", title: "Direct Nameserver", path: "dns.direct-nameserver", control: .stringList),
        BackendConfigField(section: "DNS", title: "Direct Nameserver Follow Policy", path: "dns.direct-nameserver-follow-policy", control: .toggle),
        BackendConfigField(section: "DNS", title: "Fallback", path: "dns.fallback", control: .stringList),
        BackendConfigField(section: "DNS", title: "Fallback GEOIP", path: "dns.fallback-filter.geoip", control: .toggle),
        BackendConfigField(section: "DNS", title: "Fallback GEOIP Code", path: "dns.fallback-filter.geoip-code", control: .text),
        BackendConfigField(section: "DNS", title: "Fallback Geosite", path: "dns.fallback-filter.geosite", control: .stringList),
        ...
        BackendConfigField(section: "Sniffer", title: "Override Destination", path: "sniffer.override-destination", control: .toggle),
        BackendConfigField(section: "Sniffer", title: "Protocol Rules", path: "sniffer.sniff", control: .json),
        BackendConfigField(section: "Sniffer", title: "Force Domain", path: "sniffer.force-domain", control: .stringList),
        ...
        BackendConfigField(section: "TUN", title: "DNS Hijack", path: "tun.dns-hijack", control: .stringList),
        BackendConfigField(section: "TUN", title: "IPv4 Address", path: "tun.inet4-address", control: .stringList),
        BackendConfigField(section: "TUN", title: "IPv6 Address", path: "tun.inet6-address", control: .stringList),
        BackendConfigField(section: "TUN", title: "Auto Route", path: "tun.auto-route", control: .toggle),
        BackendConfigField(section: "TUN", title: "Auto Detect Interface", path: "tun.auto-detect-interface", control: .toggle),
        BackendConfigField(section: "TUN", title: "Auto Redirect", path: "tun.auto-redirect", control: .toggle),
        BackendConfigField(section: "TUN", title: "Strict Route", path: "tun.strict-route", control: .toggle),
        ...
        BackendConfigField(section: "TUN", title: "GSO Max Size", path: "tun.gso-max-size", control: .number),
        BackendConfigField(section: "TUN", title: "File Descriptor", path: "tun.file-descriptor", control: .number),
        BackendConfigField(section: "TUN", title: "Recvmsgx", path: "tun.recvmsgx", control: .toggle),
        BackendConfigField(section: "TUN", title: "UDP Timeout", path: "tun.udp-timeout", control: .number),
        BackendConfigField(section: "TUN", title: "IPRoute2 Table Index", path: "tun.iproute2-table-index", control: .number),
        BackendConfigField(section: "TUN", title: "IPRoute2 Rule Index", path: "tun.iproute2-rule-index", control: .number),
        BackendConfigField(section: "TUN", title: "Endpoint Independent NAT", path: "tun.endpoint-independent-nat", control: .toggle),
        BackendConfigField(section: "TUN", title: "Route Address Set", path: "tun.route-address-set", control: .stringList),
        BackendConfigField(section: "TUN", title: "Route Exclude Address Set", path: "tun.route-exclude-address-set", control: .stringList),
        BackendConfigField(section: "TUN", title: "Route Address", path: "tun.route-address", control: .stringList),
        BackendConfigField(section: "TUN", title: "Route Exclude Address", path: "tun.route-exclude-address", control: .stringList),
        BackendConfigField(section: "TUN", title: "Include Interface", path: "tun.include-interface", control: .stringList),
        BackendConfigField(section: "TUN", title: "Exclude Interface", path: "tun.exclude-interface", control: .stringList),
        BackendConfigField(section: "TUN", title: "Include UID", path: "tun.include-uid", control: .numberList),
        BackendConfigField(section: "TUN", title: "Include UID Range", path: "tun.include-uid-range", control: .stringList),
        BackendConfigField(section: "TUN", title: "Exclude UID", path: "tun.exclude-uid", control: .numberList),
        BackendConfigField(section: "TUN", title: "Exclude UID Range", path: "tun.exclude-uid-range", control: .stringList),
        BackendConfigField(section: "TUN", title: "Include Android User", path: "tun.include-android-user", control: .numberList),
        BackendConfigField(section: "TUN", title: "Include Package", path: "tun.include-package", control: .stringList),
        BackendConfigField(section: "TUN", title: "Exclude Package", path: "tun.exclude-package", control: .stringList),
        BackendConfigField(section: "TUN", title: "IPv4 Route Address", path: "tun.inet4-route-address", control: .stringList),
        ...
        BackendConfigField(section: "Geo", title: "Geodata Loader", path: "geodata-loader", control: .picker(["standard", "memconservative"])),
        BackendConfigField(section: "Geo", title: "Geosite Matcher", path: "geosite-matcher", control: .picker(["mph", "succinct"])),
        BackendConfigField(section: "Geo", title: "GEO IP URL", path: "geox-url.geo-ip", control: .text),
        BackendConfigField(section: "Geo", title: "GEO Site URL", path: "geox-url.geo-site", control: .text),
        BackendConfigField(section: "Geo", title: "GEO IP URL", path: "geox-url.geoip", control: .text),
